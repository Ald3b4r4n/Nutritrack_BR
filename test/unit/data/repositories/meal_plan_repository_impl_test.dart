...
import 'package:nutritrack_br/data/database/app_database.dart'
    hide MealPlan, MealPlanDay, MealPlanEntry;
...
void main() {
  ...
  group('MealPlanRepositoryImpl com Drift em memória (T044)', () {
    ...
    test('deve salvar e recuperar o plano, dias e entradas', () async {
      ...
      activePlanResult.fold((l) => fail('should be right'), (plan) {
        expect(plan?.id, 'p1');
      ...
      daysResult.fold((l) => fail('should be right'), (days) {
      ...
      entriesResult.fold((l) => fail('should be right'), (entries) {
